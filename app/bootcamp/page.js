  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
        <header className="bg-base-100 text-center py-6 md:py-8">
          <Image src={logo} alt="Brighter Tunnel Logo" width={100} height={100} className="mx-auto" />
          <h1 className="text-2xl md:text-4xl font-bold mt-4">Brighter Tunnel | Coding Bootcamp</h1>
          <p className="text-lg md:text-xl mt-2">Transform your life in 12 weeks and become a software engineer with expertise in AI.</p>
        </header>
        <main className="p-4 md:p-8">
          <section className="my-4 md:my-8">
            <h2 className="text-xl md:text-2xl font-bold">Why Choose Our Bootcamp?</h2>
            <p className="mt-2 md:mt-4 text-gray-700">
          ...
          <section className="my-4 md:my-8">
            <h2 className="text-xl md:text-2xl font-bold">Curriculum</h2>
            <p className="mt-2 md:mt-4 text-gray-700">
          ...
          <section className="my-4 md:my-8">
            <h2 className="text-xl md:text-2xl font-bold">Details</h2>
            <ul className="list-disc list-inside mt-2 text-gray-700">
          ...
          <section className="my-4 md:my-8 text-center">
            <h2 className="text-xl md:text-2xl font-bold text-blue-800">Join Us and Transform Your Future</h2>
            <p className="mt-2 md:mt-4 text-gray-700">Interested in becoming a part of our first cohort? Show your interest below or email us at <a href="mailto:Mubarak@brightertunnel.com" className="text-blue-800">Mubarak@brightertunnel.com</a></p>
            <button
              onClick={handleModalOpen}
              className="bg-blue-600 text-white py-2 px-4 md:py-2 md:px-6 rounded-full mt-3 hover:bg-blue-700 transition duration-200"
            >
              Show Your Interest
            </button>
          </section>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-full md:max-w-2xl mx-auto">
